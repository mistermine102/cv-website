...
<template>
  <section>
    ...
    <div ref="skillContainerRef" class="flex flex-wrap justify-center">
      <div v-for="skill of skills.main" :key="skill.name" class="w-1/5">
    ...
    <div class="flex flex-wrap justify-center mt-4">
      <div v-for="skill of skills.additional" :key="skill.name" class="w-1/6">
        <div class="m-4 px-8 py-4 bg-white bg-opacity-5 rounded-lg">
          <img class="aspect-[5/3] object-contain" :src="skill.image.src" :alt="skill.name" />
        </div>
      </div>
    </div>
  </section>
